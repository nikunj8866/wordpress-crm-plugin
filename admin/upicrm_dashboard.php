        ...
        if(isset($_GET['action'])) {
            ...
            if ($UpiCRMUsers->get_permission() == 1) {
                ...
                if(isset($_COOKIE['upicrm_lead_table_from_date'])&&isset($_COOKIE['upicrm_lead_table_to_date'])) {
                    ...
                    $totalLeadClosed = $UpiCRMStatistics->get_total_closed_leads_by_user_id($user_id, $check_date, $status_id, $_COOKIE['upicrm_lead_table_from_date'], $_COOKIE['upicrm_lead_table_to_date']);
                    ...
                    $totalLeadClosed = $UpiCRMStatistics->get_total_closed_leads_by_user_id($user_id, $check_date, $status_id);
            ...
            if ($UpiCRMUsers->get_permission() == 2) {
                ...
                if(isset($_COOKIE['upicrm_lead_table_from_date'])&&isset($_COOKIE['upicrm_lead_table_to_date'])) {
                    ...
                    $totalLeadClosed = $UpiCRMStatistics->get_total_closed_leads_by_user_id(0, $check_date, $status_id, $_COOKIE['upicrm_lead_table_from_date'], $_COOKIE['upicrm_lead_table_to_date']);
                    ...
                    $totalLeadClosed = $UpiCRMStatistics->get_total_closed_leads_by_user_id(0, $check_date, $status_id);
